...
function Component_12_2_5() {
  ...
  return (
    <div
      ...
      data-component-id="Component_12_2_5"
    >
      <div
      ...
      >
        <div className="px-6 pb-6">
          <p className="text-[#363d43] leading-[24px] my-0">
            We charge $2 per successful verification. There are no setup fees, no minimums, and no contracts. You only pay when the verification is fully completed with all the details you need.
          </p>
        </div>
      </div>
    </div>
...
export default Component_12_2_5;
