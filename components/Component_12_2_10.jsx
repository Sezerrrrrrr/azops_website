...
function Component_12_2_10() {
  ...
  return (
    <div
      ...
      data-component-id="Component_12_2_10"
    >
      <div
      ...
      >
        <div className="px-6 pb-6">
          <p className="text-[#363d43] leading-[24px] my-0">
            Yes. Our entire system and processes are fully HIPAA-compliant to protect your patients' PHI at every step.
          </p>
        </div>
      </div>
    </div>
...
export default Component_12_2_10;
