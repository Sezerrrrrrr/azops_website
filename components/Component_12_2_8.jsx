...
function Component_12_2_8() {
  ...
  return (
    <div
      ...
      data-component-id="Component_12_2_8"
    >
      <div
      ...
      >
        <h3 className="text-[#101920] text-xl font-normal caret-[#101920] my-0">
          How does the integration with our PMS work?
        </h3>
        <svg
          width="24"
          height="24"
      ...
      >
        <div className="px-6 pb-6">
          <p className="text-[#363d43] leading-[24px] my-0">
            We work with Open Dental, Dentrix and Eaglesoft, we setup the integration and Natalie becomes part of your team.
          </p>
        </div>
      </div>
    </div>
...
export default Component_12_2_8;
