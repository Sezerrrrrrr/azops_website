...
function Component_12_2_2() {
  ...
  return (
    <div
      ...
      data-component-id="Component_12_2_2"
    >
      <div
      ...
      >
        <div className="px-6 pb-6">
          <p className="text-[#363d43] leading-[24px] my-0">
            All of them. The AI voice agent can call any dental insurance carrier in the U.S., including smaller regional ones that don't support electronic verification.
          </p>
        </div>
      </div>
    </div>
...
export default Component_12_2_2;
