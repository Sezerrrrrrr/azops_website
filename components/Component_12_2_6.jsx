...
function Component_12_2_6() {
  ...
  return (
    <div
      ...
      data-component-id="Component_12_2_6"
    >
      <div
      ...
      >
        <div className="px-6 pb-6">
          <p className="text-[#363d43] leading-[24px] my-0">
            A verification is considered successful only when the AI agent retrieves all the information you need from the insurance representative. If any details are missing and your team has to call the insurance themselves, you are not charged for that verification.
          </p>
        </div>
      </div>
    </div>
...
export default Component_12_2_6;
