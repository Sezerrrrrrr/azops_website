...
function Component_12_2_7() {
  ...
  return (
    <div
      ...
      data-component-id="Component_12_2_7"
    >
      <div
      ...
      >
        <div className="px-6 pb-6">
          <p className="text-[#363d43] leading-[24px] my-0">
            No. You only pay per successful verification and can stop anytime, no long-term commitments or hidden costs.
          </p>
        </div>
      </div>
    </div>
...
export default Component_12_2_7;
